...
public class HelloServiceServiceLocator extends org.apache.axis.client.Service implements helloService.HelloServiceService {
    ...
    private java.lang.String HelloService_address = "http://localhost:8080/helloService/services/HelloService";
    ...
    public helloService.HelloService getHelloService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            helloService.HelloServiceSoapBindingStub _stub = new helloService.HelloServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (helloService.HelloService.class.isAssignableFrom(serviceEndpointInterface)) {
                helloService.HelloServiceSoapBindingStub _stub = new helloService.HelloServiceSoapBindingStub(new java.net.URL(HelloService_address), this);
                _stub.setPortName(getHelloServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://helloService", "HelloServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://helloService", "HelloService"));
        }
