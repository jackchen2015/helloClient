...
public class HelloServiceProxy implements helloService.HelloService {
  private String _endpoint = null;
  private helloService.HelloService helloService = null;
  ...
  private void _initHelloServiceProxy() {
    try {
      helloService = (new helloService.HelloServiceServiceLocator()).getHelloService();
  ...
  public helloService.HelloService getHelloService() {
    if (helloService == null)
      _initHelloServiceProxy();
    return helloService;
  }
